...
class OrcamentoController extends Controller
{
    ...
    enfermaria_sem_coparticipacao_total
     ...
     WHERE fora.faixa_etaria_id IN($chaves) AND tabela_origens_id =  $cidade AND administradora_id = $administradora AND odonto = $odonto
...
AS full_tabela");
        ...
        $consultas_eletivas = $pdf->consultas_eletivas;
        $consultas_de_urgencia = $pdf->consultas_urgencia;
        $exames_simples = $pdf->exames_simples;
        $exames_complexos = $pdf->exames_complexos;
